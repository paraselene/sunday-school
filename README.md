...
使用 Safari 開啟網站，點選「分享」→「加入主畫面」→「加入」（如有「作為網頁 App 開啟」選項，請保持開啟）。主畫面會顯示紫色書本點名圖示及「主日學點名」名稱，開啟後以獨立 App 視窗顯示。英文介面會使用英文名稱。

更新網站後，舊的主畫面捷徑可能需要刪除再加入，才能更新圖示與名稱。點名及報表仍需網絡連線。
